...
class Woo_Swish_Settings
{
     ...
     * @return array
     */
    public static function get_fields($connection_type, $service_is_connected, $service_uuid)
    {
        ...
        $defaultfields = array(
            ...
            'swish_central_callback_enable' => array(
        ...
        return array_merge($prefields, $connect_fields, $service_fields, $defaultfields);
    }
