...
function init_swish_gateway()
{
    ...
    class Woo_Swish_Ecommerce extends WC_Payment_Gateway
    {
        ...
        {
            $account_uuid = ($temp_uuid = $this->get_option('swish_account_uuid'))? $temp_uuid : '---';
            $this->form_fields = Woo_Swish_Settings::get_fields($this->get_option('connection_type'), $this->get_option('swish_refresh_token') != '', $account_uuid);
        }
