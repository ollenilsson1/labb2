...
* Leaflet maps support for free maps, no API key needed
* Gutenberg editor support with map and mashup blocks
...
* Add locations by address, place, or latitude/longitude, or drag markers into position
...
* Size maps by pixels, viewport units, or percent
* Generate maps using PHP for use in theme templates
* Fully WPML compatible

= Pro Version Features =
* Get [MapPress Pro](https://mappresspro.com/mappress) for additional functionality
* Upload custom markers, or create them with the built-in icon editor
* Icon editor provides thousands of icons and customizable shapes and colors
* Gutenberg "mashup" block for searchable maps from multiple posts - great for a local directory site or store locator
* Filter locations by taxonomies, tags and categories
* Map widget and mashup widget
* Marker clustering for Google and Leaflet
* Support for all major geocoders including Google, Nominatim, Algolia and Mapbox
...
* Add KML map overlays
* Google drawing manager for drawing polygons, circles, and lines
* MultiSite compatible
* Advanced Custom Fields support, including front-end map input
